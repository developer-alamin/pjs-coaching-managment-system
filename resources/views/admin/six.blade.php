@extends('backend.app')
@section('title','Admin | Six')
@section('content')
<br>
<div class="sixStudentData">
  <div class="card">
    <div class="card-header">
      <strong>PJS Six Student Data</strong>
...
{{-- six edit modal show start form here --}}
<div class="modal fade" id="sixUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-lg ">
    <div class="modal-content">
      <div class="modal-header">
        <h6>PJS Coahing Center Six Student Data Show</h6>
        <div class="sixEditIdDiv">
          <h4></h4>
        </div>
      </div>
      ...
      <form id="fiveUpdateForm" class="" enctype="multipart/form-data"> @csrf <div class="modal-body p-4 bg-light">
...
{{-- six edit modal show end form here --}}
@endsection
@section('script')
        ...
        .then(function(response) {
            if (response.status == 200) {
                ...
                $.each(getData, function(i) {
                    ...
                    $('<tr>').html(name + fname + mname + studentId + phone + post + category + classs + taka + img + edit + deleted).appendTo('.sixTbody');

                });

                $(".editButton").click(function() {
                    var id = $(this).data('edit');
                    $("#sixUpdateModal").modal('show');
                    $(".sixEditIdDiv h4").html(id);
                    SixEditShow(id);
                })
...
function sixDelete(deleteId) {
    ...
    swal({
      title: "Are you sure?",
      text: "Are You Want To Six Student Data Deleted!",
      icon: "warning",
      buttons: true,
      dangerMode: true
    })
