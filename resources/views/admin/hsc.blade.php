...
<div class="hscStudentDiv">
  ...
  {{-- hsc edit modal show start form here --}}
<div class="modal fade" id="hscUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  data-bs-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-lg ">
    <div class="modal-content">
      <div class="modal-header">
        <h6>PJS Coahing Center HSC Student Data Show</h6>
        <div class="hscEditIdDiv">
          <h4></h4>
        </div>
      </div>
...
{{-- hsc edit modal show end form here --}}
@endsection
@section('script')
        ...
        .then(function (response) {
          if (response.status == 200) {
            ...
            var deleted = "<td class='deleteTd'><i class='deleteButton fa fa-trash' data-delete='" + getData[i].id + "'></i></td>";
              $('<tr>').html(name+fname+mname+studentId+phone+post+category+classs+taka+img+edit+deleted).appendTo('.hscTbody');
            ...
            $(".editButton").click(function() {
                ...
                $("#hscUpdateModal").modal('show');
                $(".hscEditIdDiv h4").html(id);
                hscEditShow(id);
            });
...
function hscDelete(deleteId) {
    ...
    swal({
      title: "Are you sure?",
      text: "Are You Want To HSC Student "+deleteId+" Number Data Deleted!",
      icon: "warning",
      buttons: true,
      dangerMode: true
    })
