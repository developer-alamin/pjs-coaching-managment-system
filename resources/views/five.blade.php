  ...
  axios.post(url, data)
    .then(function(response) {
      if (response.status == 200) {
        ...
        $('#upfname').val(jsonShowData[0].fname);
        $('#upmname').val(jsonShowData[0].mname);
        $('#upemail').val(jsonShowData[0].email);
        $('#upstudentid').val(jsonShowData[0].studentId);
        $('#upphone').val(jsonShowData[0].phone);
        $('#uppost').val(jsonShowData[0].post);
        $('#upcategory').val(jsonShowData[0].category);
        $('#uptaka').val(jsonShowData[0].taka);
        $('#upclass').val(jsonShowData[0].class);
        $('#upvillage').val(jsonShowData[0].village);

        $('.UpdateShowImg img').attr('src', jsonShowData[0].img);
        $('#preImg').val(jsonShowData[0].img);
