		        ...
		        <div class="form-row">
		          <div class="col-4">
		            ...
		            <div class="col-4">
		              ...
		              <input type="email" name="email" id="email" class="form-control" placeholder="Student Email Address">
		              <font>{{ ($errors->has('email'))?($errors->first('email')):'' }}</font>
		            </div>
		             <div class="col-4">
		              <label for="studentid">Student Id:</label>
		              <input type="number" name="studentid" id="studentid" class="form-control" placeholder="Pjs Student Id">
		              <font>{{ ($errors->has('studentid'))?($errors->first('studentid')):'' }}</font>
		            </div>
		        </div>
		        <br>
		        <div class="form-row">
		            <div class="col-4">
		              ...
		              <input type="number" name="phone" id="phone" class="form-control" placeholder="Student phone Number">
		              <font>{{ ($errors->has('phone'))?($errors->first('phone')):'' }}</font>
		            </div>
		             <div class="col-4">
