...
@section('content')
	<div class="sevenRootDiv">
		<div class="sevenTitleDiv">
			<h4 class="sevenTitle">Seven Student Table</h4>
			 <img src="{{asset('img/pjs.jpg')}}" class="previewImg">
		</div>
		<div class="sevenTableDiv">
...
<div class="modal fade" id="sevenUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel"
